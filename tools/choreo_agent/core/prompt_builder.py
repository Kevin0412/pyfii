...
- 不要直接写 `inittime()`；跨段对齐由 `auto_init` 处理"""
    ...
    quality_budget = (
        ...
        f"    `geo = custom_points([(80,470,150),(220,510,200),(360,450,170),(500,500,160),(540,410,190),  # 上带5机 y>400`\n"
        f"    `                     (90,150,160),(250,90,200),(410,140,170),(540,190,150)], n=len(drones), min_xy_cm=70)  # 下带4机 y<200`\n"
        f"  （范例数值，按主题/上一段出口改，别照抄；要点：两带 y 间隔 >200cm，两组各待自己带，航线天然不交叉）\n"
